...
assert.match(server, /const ESTACOES_CASA_REL = Object\.freeze\(\{[\s\S]*secagem: \{ x: 6\.8, z: 3\.6, raio: 2\.35 \},[\s\S]*cura: \{ x: 3\.8, z: 3\.6, raio: 2\.35 \},[\s\S]*embalagem: \{ x: \.8, z: 3\.6, raio: 2\.35 \}/,
...
assert.match(client, /const estacoes=\{secagem:\{x:6\.8,z:3\.6\},cura:\{x:3\.8,z:3\.6\},embalagem:\{x:\.8,z:3\.6\}\}/,
